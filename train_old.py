...
from gaussian_renderer import render_old, network_gui
import sys
...
def scene_reconstruction(dataset, opt, hyper, pipe, testing_iterations, saving_iterations,
    ...
    for iteration in range(first_iter, final_iter+1):
        ...
        for viewpoint_cam in viewpoint_cams:
            ...
            render_pkg = render_old(viewpoint_cam, gaussians, pipe, background, cam_no=cam_no, iter=iteration, num_down_emb_c=hyper.min_embeddings, num_down_emb_f=hyper.min_embeddings)
        ...
        with torch.no_grad():
            ...
            if (tb_writer and (iteration % 100 == 0)):
                ...
                render_pkg = render_old(viewpoint_cam, gaussians, pipe, background,
                                    cam_no=test_cam.cam_no, iter=iteration,
